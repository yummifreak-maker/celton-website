        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          >
            <motion.div variants={fadeUp} className="mb-8">
              <h2 className="text-lg font-semibold text-celton-light mb-2">Agreement to Terms</h2>
            ...
            <motion.div variants={fadeUp} className="mb-8">
              <h2 className="text-lg font-semibold text-celton-light mb-2">Use of Services</h2>
            ...
            <motion.div variants={fadeUp} className="mb-8">
              <h2 className="text-lg font-semibold text-celton-light mb-2">Intellectual Property</h2>
              <p className="text-celton-silver leading-relaxed text-xs">
            ...
            <motion.div variants={fadeUp} className="mb-8">
              <h2 className="text-lg font-semibold text-celton-light mb-2">Disclaimer of Warranties</h2>
              <p className="text-celton-silver leading-relaxed text-xs">
            ...
            <motion.div variants={fadeUp} className="mb-8">
              <h2 className="text-lg font-semibold text-celton-light mb-2">Limitation of Liability</h2>
              <p className="text-celton-silver leading-relaxed text-xs">
            ...
            <motion.div variants={fadeUp} className="mb-8">
              <h2 className="text-lg font-semibold text-celton-light mb-2">Changes to Terms</h2>
              <p className="text-celton-silver leading-relaxed text-xs">
