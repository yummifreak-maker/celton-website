        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          >
            <motion.div variants={fadeUp} className="mb-12">
              <h2 className="text-2xl font-semibold text-celton-light mb-4">Overview</h2>
            ...
            <motion.div variants={fadeUp} className="mb-12">
              <h2 className="text-2xl font-semibold text-celton-light mb-4">Information We Collect</h2>
            ...
            <motion.div variants={fadeUp} className="mb-12">
              <h2 className="text-2xl font-semibold text-celton-light mb-4">How We Use Your Information</h2>
              <p className="text-celton-silver leading-relaxed mb-4">
            ...
            <motion.div variants={fadeUp} className="mb-12">
              <h2 className="text-2xl font-semibold text-celton-light mb-4">Data Security</h2>
              <p className="text-celton-silver leading-relaxed">
            ...
            <motion.div variants={fadeUp} className="mb-12">
              <h2 className="text-2xl font-semibold text-celton-light mb-4">Your Rights</h2>
              <p className="text-celton-silver leading-relaxed mb-4">
            ...
            <motion.div variants={fadeUp} className="mb-12">
              ...
              <p className="text-celton-silver leading-relaxed">
                ...
                <a href="mailto:privacy@celton.ai" className="text-celton-accent hover:underline">privacy@celton.ai</a>.
              </p>
            </motion.div>
          </motion.div>
        </div>
